...
<html>
 <head>
  ...
  <script type="text/javascript">
   function refresh(){
       // parent.layer.close(parent._layer_hander);
 ...
 <body>
  <div id="wrapper">
    <p class="msg-title">{%if $type == 1%}警告！{%else%}提示！{%/if%}</p>
        ...
        <p class="notice">页面将在 <span style="color:blue;font-weight:bold">3</span> 秒后自动关闭，如果不想等待,直接点击
        <a href="javascript:;" onclick="refresh()">这里</a> 关闭</p>  </div>
 </body>
</html>
